...
export const ConfirmationDialog = ({ open, title, message, confirmLabel = 'Confirm', onConfirm, onClose, danger = false }) => <Modal open={open} title={title} onClose={onClose} footer={<><Button variant="secondary" onClick={onClose}>Cancel</Button><Button variant={danger ? 'danger' : 'primary'} onClick={onConfirm}>{confirmLabel}</Button></>}><p>{message}</p></Modal>;
