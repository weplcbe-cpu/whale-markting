...
export const CommentsHistory = () => {
  ...
  return <div className="ds-page">
    ...
    <Modal open={newComment} onClose={() => setNewComment(false)} title="Add Director Feedback" className="director-feedback-form-modal" footer={<><Button variant="secondary" onClick={() => setNewComment(false)}>Cancel</Button><Button type="submit" form="director-feedback-form">Send Feedback</Button></>}>
