...
export const PerformanceAnalytics = () => {
  const { users, visitPlans, visitReports, dailyReports, followUps, tenders } = useApp();
  ...
  const rows = marketingReps.map((rep) => {
    ...
    const opportunityScore = Math.min(100, (quotations + opportunities) * 12.5);
